...
export function filterProducts(
  ...
  return async (dispatch: any) => {
    if (type === "fire" || type === "water" || type === "") {
      dispatch(actions.filterProducts(type));
    }
  };
}

export function fetchPokemonsFire(): ThunkAction<
  Promise<void>,
  RootState,
  any,
  any
    ...
    return axios
      ...
      .then((r: any) => {
        ...
        pokemons.forEach((item) => {
          dispatch(fetchPokemon(item.pokemon.url, "fire"));
        });
...
export function fetchPokemonsWater(): ThunkAction<
  Promise<void>,
  RootState,
  any,
  any
    ...
    return axios
      ...
      .then((r: any) => {
        ...
        pokemons.forEach((item: any) => {
          dispatch(fetchPokemon(item.pokemon.url, "water"));
        });
